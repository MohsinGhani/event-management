...
class VendorFeedBackForm extends Component {
  constructor(props) {
    super(props);
            ...
            <div style={{ margin: "30px 0px" }}>
              ...
              <div>
                <div style={{ fontWeight: 500 }}>
                  How would you rate our online payment facility?
                </div>
                <div>
                  <RatingSystem
              ...
              <div>
                <div style={{ fontWeight: 500 }}>
                  How was our CSR with the venue confirmation and assistance?
                </div>
                <div>
                  <RatingSystem
              ...
              <div>
                <div style={{ fontWeight: 500 }}>
                  How about our promotional effectiveness?
                </div>
                <div>
                  <RatingSystem
                    rating={futureRating}
              ...
              <div>
                <div style={{ fontWeight: 500 }}>
                  How likely you are satisfied with our policy concerns?
                </div>
                <div>
                  <RatingSystem
